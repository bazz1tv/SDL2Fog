...
SDL_Surface *SDL_PNGFormatAlpha(SDL_Surface *src)
{
	...
	// Had a problem before where i oddly had to do GRBA as you see below for the masks...
	// Now in SDL2, the code does not even execute this part of the code (it return src; above)
	SDL_Surface *surf = SDL_CreateRGBSurface(0, src->w, src->h, 24,
											 src->format->Gmask, src->format->Rmask, src->format->Bmask, src->format->Amask);
